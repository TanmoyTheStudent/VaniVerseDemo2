...
import EarnImage from '../../requiredData/images/earnMoney.jpeg';
                ...
                <Container>
                    ...
                    >
                        <Grid item sm={12} md={6} lg={6} sx={{ display: 'flex', justifyContent: 'center', marginTop: "30px" }}>
                            <Card
                                sx={{ width: '100%', height: "100%", padding: { xs: '10px', md: '20px' }, margin: '0px', boxShadow: "none", background: "none", align: "center" }} >
                                <CardActionArea>
                                    <CardMedia
                                        component="img"
                                        image={EarnImage}
                                        alt="services image"
                                        sx={{ width: { xs: "90%", sm: "70%", md: "100%", lg: "90%" }, borderRadius: "50px" }}
                        ...
                        <Grid item sm={12} md={6} lg={6} sx={{ display: 'flex', justifyContent: 'center' }}>
                            <Card sx={{ width: '100%', height: "100%", padding: { xs: "0px", sm: '10px', md: "0px", lg: "20px" }, marginTop: { xs: 0, md: "5%", lg: "2.5%", xl: "1.5%" }, boxShadow: "none", background: "none", align: "center" }}  >
                                <CardActionArea>
