...
export const earnData=[
    {
        ...
        description:"Here you have to record the speech of your community speaking in your language with a valid consent so that it can be used in commercial purposes."
    },
    {
        id:2,
        title:"Audio Segmentation",
        description:"If you are good at your language, you can participate in audio segmentation activity. Audio segmentation encompasses various categories, including speaker recognition, noise segmentation, and specific sound identification."
    },
    {
        id:3,
        title:"Transcription",
